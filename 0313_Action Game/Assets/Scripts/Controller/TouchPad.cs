...
public class TouchPad : MonoBehaviour
{
    ...
    private Vector3 _startPos = Vector3.zero; // zero = 0

    // 방향 컨트롤러가 원으로 움직이는 반지름
    public float _dragRadius = 10.0f;
...
// 유니티 에디터 / 웹 / 인게임에서 마우스 클릭으로 작업합니다.
    ...
    void HandleInput(Vector3 input)
    {
        ...
        if (_buttonPressed)
        {
            ...
            // sqrMagnitude는 두 점 간의 거리
            // 비슷한 개념 Vector3.Distance (연산속도가 느린 편) , 대신 건축물 같은 정교한 값을 구할 때 사용
            // sqrManitude는 단순하게 두 점 사이의 거리를 구할 때 사용
