...
// 2. 상속 class 자식 클래스명 : 부모 클래스명의 형태로 설계합니다.
...
// Dictionary<T>                특정 키를 통해 특정 값을 조회하는 경우에 해당 자료구조를 사용합니다.
...
// Stack<T>          O(1)           -            O(1)          -
// Queue<T>          O(1)           -            O(1)          -
// Dictionary<T>     O(1)          O(1)          O(1)          - (인덱스 대신에 키를 인덱스처럼 사용합니다.)
